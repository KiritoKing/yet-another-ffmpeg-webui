...
export default function FFmpegAdvanced() {
  ...
  const [customCommand, setCustomCommand] = useState('-i input.mp4 -c copy output.mp4');
    ...
    try {
      ...
      const service = new FFmpegService({
        ...
        onProgress: (progress, time) => {
          addLog(`处理进度: ${(progress * 100).toFixed(2)}% (${(time / 1000000).toFixed(2)}s)`, 'info');
        },
      });
                ...
                <>
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-xs text-gray-500">
                      注意：输入文件必须命名为 <code className="bg-gray-100 px-1 py-0.5 rounded">input.mp4</code>
                    </p>
                  </div>
            ...
            <div className="space-y-3 text-sm text-gray-600">
              ...
              <div className="pt-3 border-t border-gray-200">
                ...
                <ul className="mt-2 space-y-1 font-mono text-xs">
                  <li>• <code>-i input.mp4 -c copy output.mp4</code> - 复制流</li>
                  <li>• <code>-i input.mp4 -vf scale=640:360 output.mp4</code> - 调整大小</li>
                  <li>• <code>-i input.mp4 -ss 00:00:10 -t 00:00:05 -c copy output.mp4</code> - 剪辑片段</li>
                </ul>
              </div>
            </div>
          </div>
